...
<%--搭建显示页面--%>
            <div class="container">
                ...
                <div class="col-md-4 col-md-offset-8">
                    ...
                    <button class="btn btn-danger btn-sm" id="emp_delete_all_ben">删除</button>
                </div>
                <%--  显示表格数据   --%>
                <div class="row"></div>
                <div class="col-md-12">
            ...
            <script type="text/javascript">
                ...
                function getDepts(ele) {
                    ...
                    $.ajax({
                      ...
                      success:function (result){
                          //console.log(result);
                          //显示部门信息在模态框下拉列表中
                         // $("#dept_add_select").append("")  等同于 $("#empAndModel select")
                ...
                //1.我们是按钮创建之前就绑定了click，所以是绑定不上的
                //  1) 我们可以在创建按钮的时候绑定
                //  2) 绑定点击 .live()
                // jQuery新版没有live，使用 on 进行替代
            ...
            //完成全选/全不选功能
                $("#check_all").click(function () {
                    //attr 获取 checked是undefined
                    //我们这些dom原生的属性 用 prop，attr获取自定义属性的值
                    //prop用来修改和获取dom原生属性的值
                ...
                //点击全部删除，就批量删除
                $("#emp_delete_all_ben").click(function () {
                    // $(".check_item:checked")
                    var empNames = "";
                    var del_idstr = "";
